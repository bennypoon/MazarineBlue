...
import org.mazarineblue.keyworddriven.util.TestConflictingKeywordsLibraryStub;
import org.mazarineblue.keyworddriven.util.TestEmptyLibraryStub;
import org.mazarineblue.keyworddriven.util.TestFilledLibrarySpy;
import org.mazarineblue.keyworddriven.util.TestNonPublicInstructionLibraryStub;
...
public class LibraryUsingProcessorTest {
    ...
    private static final String NON_PUBLIC_LIBRARY_INSTRUCTION = TestNonPublicInstructionLibraryStub.NON_PUBLIC_LIBRARY_INSTRUCTION;
    ...
    public void creation_ConflictingKeywords_ThrowsKeywordConflictException() {
        new TestConflictingKeywordsLibraryStub();
    }
    ...
    public void creation_NonPublicMethod_ThrowsInstructionInAccessibleException() {
        new TestNonPublicInstructionLibraryStub();
    }
    ...
    public void fetchLibraries_True_AllFound() {
        ...
        feed.add(new AddLibraryEvent(new TestEmptyLibraryStub(REGISTRED_NAMESPACE)));
