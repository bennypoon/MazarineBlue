...
public class ExecuteInstructionLineEventTest {
    ...
    private class TestExecuteInstructionLineEvent
        ...
        TestExecuteInstructionLineEvent(String path) {
            super(path);
        }
    ...
    @Test
    public void responce_Initial() {
        assertEquals("", e.responce());
    }

    @Test
    public void responce_ExceptionWithCause() {
        e.setException(new RuntimeException("message", new RuntimeException("cause")));
        assertEquals("exception=message", e.responce());
    }

    @Test
    public void responce_Result() {
        e.setResult("message");
