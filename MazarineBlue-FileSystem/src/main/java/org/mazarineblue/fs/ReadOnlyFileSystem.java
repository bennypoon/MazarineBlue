...
/**
 * An {@code ReadOnlyFileSystem} is a {@code AdapterFileSystem} that acts as if all file are unwritable.
 *
...
public class ReadOnlyFileSystem
    ...
    /**
     * Creates a {@code ReadOnlyFileSystem}.
     *
     * @param adaptee the other file system to adapt the implementation from.
     */
    public ReadOnlyFileSystem(FileSystem adaptee) {
        super(adaptee);
    }
