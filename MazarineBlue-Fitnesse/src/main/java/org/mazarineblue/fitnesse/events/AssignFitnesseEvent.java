...
import org.mazarineblue.fitnesse.FitnesseSubscriber;
...
public class AssignFitnesseEvent
    ...
    private final SerializableObjectWrapper value;
    ...
    @Override
    public int hashCode() {
        return 15463 + 47 * Objects.hashCode(this.symbol) + Objects.hashCode(this.value);
    }
