...
public class FixtureLibrary
    ...
    private final SerializableObjectWrapper caller;
    ...
    public FixtureLibrary(String namespace, Object caller) {
        super(namespace);
        this.caller = new SerializableObjectWrapper(caller);
    ...
    private static int minimalRequiredArguments(Method method) {
        ...
        for (int i = parameterTypes.length - 1; i >= 0; --i)
            if (PRIMATIVES.isPrimative(parameterTypes[i]))
                return i + 1;
        return 0;
    }
    ...
    protected Object getCaller() {
        return caller.getObject();
    }

    @Override
    public int hashCode() {
        return 2023 + 17 * super.hashCode() + Objects.hashCode(this.caller);
    }
