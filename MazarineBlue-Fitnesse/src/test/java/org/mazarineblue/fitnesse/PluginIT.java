...
import org.mazarineblue.fitnesse.util.FitnesseUtil;
...
public class PluginIT {
    ...
    public void testScript()
        ...
        long before = FitnesseUtil.getMemoryFootprint();
        ...
        double diffMB = FitnesseUtil.getMemoryFootprintDiff(before, MB);
        assertEquals(2d, diffMB, 2d);
    }
