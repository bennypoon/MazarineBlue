 ...
 */
package org.mazarineblue.fixtures;
...
import org.mazarineblue.fixtures.events.NewInstanceEvent;
import org.mazarineblue.fixtures.events.PathEvent;
import org.mazarineblue.fixtures.exceptions.FixtureNotFoundException;
import org.mazarineblue.fixtures.exceptions.FixtureNotPublicException;
import org.mazarineblue.fixtures.exceptions.NoSuchConstructorException;
...
public class ClassLoaderLinkTest {
    ...
    public void eventHandler_NonExistingFixture_FixtureNotFoundException()
            throws Exception {
        FixtureLoaderLink link = new FixtureLoaderLink("org.mazarineblue.fixtures.util");
    ...
    public void test()
        ...
        Event[] arr = new Event[]{
            new PathEvent("org.mazarineblue.fixtures.util"),
