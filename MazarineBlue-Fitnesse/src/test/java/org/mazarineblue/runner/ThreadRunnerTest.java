...
import org.mazarineblue.runner.exceptions.TimeoutException;
import org.mazarineblue.runner.util.InterpreterFactoryAdopter;
import org.mazarineblue.runner.util.WaitingInterpreterDummy;
...
public class ThreadRunnerTest {
    ...
    public class FullPipe {
        ...
        public void setup()
                throws InterruptedException {
            runner = new ThreadRunner(pipe.redirect(), null, 2 * DOZE);
            fillPipe();
        }
    ...
    public class RunnerInWaitForEverMode {
        ...
        private void startRunnerInWaitForEverMode()
                throws InterruptedException {
            InterpreterFactory factory = new InterpreterFactoryAdopter(new WaitingInterpreterDummy());
            runner = new ThreadRunner(pipe.redirect(), factory, DOZE);
            runner.start();
        }
