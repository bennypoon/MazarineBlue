...
class TransitionImpl
    ...
    @Override
    public TransitionImpl setGuard(String guard) {
        this.guard = guard;
        return this;
    }
    ...
    @Override
    public TransitionImpl setBusinessValue(int value) {
    ...
    @Override
    public TransitionImpl setSources(State... states) {
    ...
    @Override
    public TransitionImpl setDestination(State state) {
        destination = state;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return 7099285 + super.hashCode()
                + 83521 * Objects.hashCode(guard)
                + 4913 * businessValue
                + 289 * Objects.hashCode(sources)
