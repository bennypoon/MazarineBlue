...
public class AboutDialog
    ...
    private final transient AboutModel model;
     ...
     * @param model   the about model that perform user based actions.
     * @param fetcher the {@code ImageFetcher} who's job it is to fetch the.
     * MazarineBlue logo.
     */
    public AboutDialog(Frame owner, AboutModel model, ImageFetcher fetcher) {
        super(owner);
        this.model = model;
    ...
    private void initComponents() {
        ...
        logoPanel = new ImagePanel(fetcher.getImage());
        ...
        releaseVersionLabel.setText(model.getVersion());
        ...
        releaseDateLabel.setText(model.getBuildDate());
